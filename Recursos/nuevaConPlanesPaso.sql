...
CREATE TABLE `catastrofe` (
  ...
  `apiFb` varchar(300) DEFAULT NULL,
  `apiTw` varchar(300) DEFAULT NULL,
...
CREATE TABLE `pasos` (
  ...
  PRIMARY KEY (`idpasos`),
  KEY `idPlan` (`idPlan`),
  CONSTRAINT `idPlan` FOREIGN KEY (`idPlan`) REFERENCES `plan` (`idPlan`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2015-02-05 14:07:18
